...
{
	int speed = 30;
	float scale_reduction = 0.1;
	// TODO: update steps for translation, rotation, scale, in order to create animations
	angularStep += deltaTimeSeconds;
	translateX += speed * deltaTimeSeconds;
	translateY += speed * deltaTimeSeconds;
	scaleX += deltaTimeSeconds * scale_reduction;
	scaleY += deltaTimeSeconds * scale_reduction;
	...
	modelMatrix *= Transform2D::Rotate(2 * angularStep) * Transform2D::Translate(200 * cos(angularStep), 200 * sin(angularStep));
